function Home() {
  return (
    <div id="content" className="p-4 p-md-5" >
      ...
      <h2 className="text-center mb-5">E-Shagird</h2>
       <div className="row d-flex align-items-center">
        <div className="col-md-6">

      <h5 style={{lineHeight:"30px"}}>
        Lorem Ipsum is simply dummy . L500s, win the 1960s with the rening Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
      </h5> 
      <br/>
      <h5 style={{lineHeight:"30px"}}>
        Lorem Ipsum is simn the 1960s with the release of Letraset sheets coages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
      </h5>  
